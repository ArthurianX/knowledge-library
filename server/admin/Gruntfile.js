module.exports = function ( grunt ) {
    ...
    var taskConfig = {
        ...
        delta: {
            ...
            assets: {
                ...
                tasks: [ 'copy:build_assets', 'copy:build_vendor_assets', 'copy:build_vendor_fonts' ]
            },
            ...
            less: {
                files: [ 'src/**/*.less' ],
                tasks: [ 'recess:build', 'copy:build_vendorcss', 'concat:build_css' ]
            },
    ...
    grunt.registerTask( 'compile', [
        'recess:compile', 'copy:compile_assets', 'ngmin', 'concat:compile_js', 'uglify', 'index:compile', 'copy:move_prod', 'copy:cordova_conf_prod'
    ]);
    ...
    //Just found out the userConfig is an actual object, FFS!
    var mainFiles = userConfig.primary_files.js;
    var secondaryFiles = userConfig.vendor_files.js;

    /* WE are leaving the same files in the vendor files so we can compare the two arrays and
